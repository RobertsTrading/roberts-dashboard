...
const expected = [
  ...
  // 04/05: the sheet's typed "Total:" says 270,781.50 but its own quote rows
  // sum to 339,312.50 — per the brief, totals are recomputed from rows.
  ['04/05 – 07/05', 3,  8, 339312.5,  3, 31296,  104119],
  ['11/05 – 15/05', 3, 13, 758487.5,  5, 25055,  167855],
  ['18/05 – 22/05', 6,  8, 183349.32, 1, 9500,   71446.1],
